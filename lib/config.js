...
export function configure (cwd) {
  try {
    ...
    if (reporters)
      defaults.reporters = reporters.map(normalize)

    Object.assign(defaults, config)
    Object.assign(defaults.window, window)
    Object.assign(defaults.webPreferences, webPreferences)
  } catch {
